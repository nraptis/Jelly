...
bool ExecuteCase(const swift_test_data::TestCase& pCase,
  ...
  if (aBlockSizeParam == nullptr || aCountParam == nullptr ||
      aFrontParam == nullptr || aBackParam == nullptr ||
  ...
  jelly::WeaveByteBlockCipher aCipher(aBlockSize, aCount, aFrontStride,
                                      aBackStride);
...
int main(int argc, char** argv) {
  return test_swift_executor::RunFiles(argc, argv, "WeaveByteBlockCipher",
                                       ExecuteCase);
}
