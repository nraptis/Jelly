...
bool ExecuteCase(const swift_test_data::TestCase& pCase,
  ...
  if (aMaskParam == nullptr || aCountParam == nullptr || aFrontParam == nullptr ||
      aBackParam == nullptr || !swift_test_data::ReadUInt8(*aMaskParam, aMask) ||
  ...
  jelly::WeaveMaskCipher aCipher(aMask, aCount, aFrontStride, aBackStride);
...
int main(int argc, char** argv) {
  return test_swift_executor::RunFiles(argc, argv, "WeaveMaskCipher",
                                       ExecuteCase);
}
