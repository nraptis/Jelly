...
bool ExecuteCase(const swift_test_data::TestCase& pCase,
  ...
  if (aCountParam == nullptr || aFrontParam == nullptr || aBackParam == nullptr ||
  ...
  jelly::WeaveCipher aCipher(aCount, aFrontStride, aBackStride);
...
int main(int argc, char** argv) {
  return test_swift_executor::RunFiles(argc, argv, "WeaveCipher", ExecuteCase);
}
