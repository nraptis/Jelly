...
class RotateMaskBlockCipher final : public LayerCakeCryptDelegate {
 public:
...
using RotateMaskBlockCipher08 = RotateMaskBlockCipher<EB_BLOCK_SIZE_08>;
using RotateMaskBlockCipher12 = RotateMaskBlockCipher<EB_BLOCK_SIZE_12>;
using RotateMaskBlockCipher16 = RotateMaskBlockCipher<EB_BLOCK_SIZE_16>;
using RotateMaskBlockCipher24 = RotateMaskBlockCipher<EB_BLOCK_SIZE_24>;
using RotateMaskBlockCipher32 = RotateMaskBlockCipher<EB_BLOCK_SIZE_32>;
using RotateMaskBlockCipher48 = RotateMaskBlockCipher<EB_BLOCK_SIZE_48>;
