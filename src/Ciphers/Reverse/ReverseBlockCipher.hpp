...
class ReverseBlockCipher final : public LayerCakeCryptDelegate {
 public:
...
using ReverseBlockCipher08 = ReverseBlockCipher<EB_BLOCK_SIZE_08>;
using ReverseBlockCipher12 = ReverseBlockCipher<EB_BLOCK_SIZE_12>;
using ReverseBlockCipher16 = ReverseBlockCipher<EB_BLOCK_SIZE_16>;
using ReverseBlockCipher24 = ReverseBlockCipher<EB_BLOCK_SIZE_24>;
using ReverseBlockCipher32 = ReverseBlockCipher<EB_BLOCK_SIZE_32>;
using ReverseBlockCipher48 = ReverseBlockCipher<EB_BLOCK_SIZE_48>;
