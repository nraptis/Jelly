...
class ReverseMaskBlockCipher final : public LayerCakeCryptDelegate {
 public:
...
using ReverseMaskBlockCipher08 = ReverseMaskBlockCipher<EB_BLOCK_SIZE_08>;
using ReverseMaskBlockCipher12 = ReverseMaskBlockCipher<EB_BLOCK_SIZE_12>;
using ReverseMaskBlockCipher16 = ReverseMaskBlockCipher<EB_BLOCK_SIZE_16>;
using ReverseMaskBlockCipher24 = ReverseMaskBlockCipher<EB_BLOCK_SIZE_24>;
using ReverseMaskBlockCipher32 = ReverseMaskBlockCipher<EB_BLOCK_SIZE_32>;
using ReverseMaskBlockCipher48 = ReverseMaskBlockCipher<EB_BLOCK_SIZE_48>;
