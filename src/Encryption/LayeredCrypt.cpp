...
CryptDebugInfo LayeredCrypt::GetDebugInfo() const {
  CryptDebugInfo aInfo;
  aInfo.mLayerCipherCounts.push_back(mLayer1.CipherCount());
  aInfo.mLayerCipherCounts.push_back(mLayer2.CipherCount());
  aInfo.mLayerCipherCounts.push_back(mLayer3.CipherCount());
  aInfo.mUsesEncryption = (aInfo.mLayerCipherCounts[0] != 0u) ||
                          (aInfo.mLayerCipherCounts[1] != 0u) ||
                          (aInfo.mLayerCipherCounts[2] != 0u);
  return aInfo;
}
