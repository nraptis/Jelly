#ifndef PEANUTBUTTER_PEPPER_ADD_CIPHER_HPP_
#define PEANUTBUTTER_PEPPER_ADD_CIPHER_HPP_
...
class PepperAddCipher final : public Crypt {
 public:
  PepperAddCipher(const unsigned char* pMask, std::size_t pMaskLength)
...
#endif  // PEANUTBUTTER_PEPPER_ADD_CIPHER_HPP_
