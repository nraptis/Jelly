#ifndef PEANUTBUTTER_PEPPER_XOR_CIPHER_HPP_
#define PEANUTBUTTER_PEPPER_XOR_CIPHER_HPP_
...
class PepperXORCipher final : public Crypt {
 public:
  PepperXORCipher(const unsigned char* pMask, std::size_t pMaskLength)
...
#endif  // PEANUTBUTTER_PEPPER_XOR_CIPHER_HPP_
