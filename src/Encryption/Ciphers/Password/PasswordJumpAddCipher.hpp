#ifndef PEANUTBUTTER_PASSWORD_JUMP_ADD_CIPHER_HPP_
#define PEANUTBUTTER_PASSWORD_JUMP_ADD_CIPHER_HPP_
...
class PasswordJumpAddCipher final : public Crypt {
 public:
  PasswordJumpAddCipher(const unsigned char* pPassword,
                        int pPasswordLength,
 ...
 private:
  bool Apply(const unsigned char* pSource,
    ...
    if (pSource == nullptr || pDestination == nullptr || mPassword == nullptr ||
        mJumps == nullptr) {
      if (pErrorMessage != nullptr) {
        *pErrorMessage = "null buffer in PasswordJumpAddCipher";
      }
      return false;
    }
...
#endif  // PEANUTBUTTER_PASSWORD_JUMP_ADD_CIPHER_HPP_
