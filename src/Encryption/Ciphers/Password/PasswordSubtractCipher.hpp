#ifndef PEANUTBUTTER_PASSWORD_SUBTRACT_CIPHER_HPP_
#define PEANUTBUTTER_PASSWORD_SUBTRACT_CIPHER_HPP_
...
class PasswordSubtractCipher final : public Crypt {
 public:
  PasswordSubtractCipher(const unsigned char* pPassword, int pPasswordLength)
      : mPasswordBytes(BuildPasswordBytes(pPassword, pPasswordLength)) {}

  explicit PasswordSubtractCipher(const std::vector<unsigned char>& pPasswordBytes)
      : PasswordSubtractCipher(pPasswordBytes.data(),
...
#endif  // PEANUTBUTTER_PASSWORD_SUBTRACT_CIPHER_HPP_
